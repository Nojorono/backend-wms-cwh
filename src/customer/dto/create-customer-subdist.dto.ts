...
export class CreateCustomerSubdistDto {
  @ApiProperty({ example: 13975, description: 'Customer account ID' })
  @IsNumber()
  custAccountId: number;

  @ApiProperty({ example: 'UD. PIALA MAS JAYA', description: 'Customer name' })
  @IsString()
  customerName: string;

  @ApiProperty({ example: '11935', description: 'Customer number' })
  @IsString()
