...
export class MasterItemController {
  ...
  @ApiResponse({ status: 201, description: 'The Item has been successfully created.', type: MasterItem })
  @ApiResponse({ status: 409, description: 'Item with this SKU already exists.' })
  ...
  @ApiResponse({ status: 200, description: 'Return all Items.', type: [MasterItem] })
  findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Return the Item.', type: MasterItem })
  ...
  @ApiResponse({ status: 200, description: 'The Item has been successfully updated.', type: MasterItem })
  @ApiResponse({ status: 404, description: 'Item not found.' })
  @ApiResponse({ status: 409, description: 'Item with this SKU already exists.' })
  update(
    @Param('id') id: string,
