...
export class ChangeSchemaPallet1757383668502 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "inbound_do" ADD CONSTRAINT "FK_2f26a8c1474ad1e6b67fc2cc943" FOREIGN KEY ("inbound_id") REFERENCES "inbound"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inbound_item" ADD CONSTRAINT "FK_50fd3d2e7a52a74f6198b6b7d29" FOREIGN KEY ("inbound_id") REFERENCES "inbound"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inbound_item" ADD CONSTRAINT "FK_2c03326bdc868775b9ad272aab1" FOREIGN KEY ("inbound_do_id") REFERENCES "inbound_do"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "inbound_item" DROP CONSTRAINT "FK_2c03326bdc868775b9ad272aab1"`);
        await queryRunner.query(`ALTER TABLE "inbound_item" DROP CONSTRAINT "FK_50fd3d2e7a52a74f6198b6b7d29"`);
        await queryRunner.query(`ALTER TABLE "inbound_do" DROP CONSTRAINT "FK_2f26a8c1474ad1e6b67fc2cc943"`);
        await queryRunner.query(`ALTER TABLE "inbound_item" DROP COLUMN "inbound_do_id"`);
