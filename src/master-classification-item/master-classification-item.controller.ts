...
export class MasterClassificationItemController {
  ...
  @ApiResponse({ status: 201, description: 'The Classification Item has been successfully created.', type: MasterClassificationItem })
  @ApiResponse({ status: 409, description: 'Classification Item with this code already exists.' })
  create(@Body() createMasterClassificationItemDto: CreateMasterClassificationItemDto) {
  ...
  @ApiResponse({ status: 200, description: 'Return the Classification Item.', type: MasterClassificationItem })
  ...
  @ApiResponse({ status: 200, description: 'The Classification Item has been successfully updated.', type: MasterClassificationItem })
  @ApiResponse({ status: 404, description: 'Classification Item not found.' })
  @ApiResponse({ status: 409, description: 'Classification Item with this code already exists.' })
  update(
    @Param('id') id: string,
    @Body() updateMasterClassificationItemDto: UpdateMasterClassificationItemDto,
  ) {
  ...
  @ApiResponse({ status: 200, description: 'The Classification Item has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'Classification Item not found.' })
