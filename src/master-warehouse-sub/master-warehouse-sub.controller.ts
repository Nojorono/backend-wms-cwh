...
export class MasterWarehouseSubController {
  ...
  @ApiResponse({ status: 201, description: 'The Warehouse Sub has been successfully created.', type: MasterWarehouseSub })
  @ApiResponse({ status: 409, description: 'Warehouse Sub with this organization ID already exists.' })
  ...
  @ApiResponse({ status: 200, description: 'Return all Warehouses Sub.', type: [MasterWarehouseSub] })
  findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Return the Warehouse Sub.', type: MasterWarehouseSub })
  ...
  @ApiResponse({ status: 200, description: 'The Warehouse Sub has been successfully updated.', type: MasterWarehouseSub })
  ...
  @ApiResponse({ status: 200, description: 'The Warehouse Sub has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'Warehouse Sub not found.' })
